...
<section class="readiness"><div class="ready-item"><span>Commissioning</span><strong id="readyCommissioning">Checking</strong></div><div class="ready-item"><span>Phone camera</span><strong id="readyCamera">Checking</strong></div><div class="ready-item"><span>OpenAI Sol</span><strong id="readySol">Checking</strong></div><div class="ready-item"><span>Motion</span><strong id="readyMotion">Checking</strong></div><div class="ready-item"><span>Lichess</span><strong id="readyLichess">Checking</strong></div></section>
